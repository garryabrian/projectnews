				...
				<div id="et_pt_blog">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<div class="et_pt_blogentry clearfix">
							...
							<p class="et_pt_blogmeta"><?php _e('Posted','DelicateNews'); ?> <?php _e('by','DelicateNews'); ?> <?php the_author_posts_link(); ?> <?php _e('on','DelicateNews'); ?> <?php the_time(get_option('delicatenews_date_format')) ?> <?php _e('in','DelicateNews'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','DelicateNews'), __('1 comment','DelicateNews'), '% '.__('comments','DelicateNews')); ?></p>
