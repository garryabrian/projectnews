...
<body<?php if (is_home()) echo(' id="home"'); ?><?php if ( get_option('delicatenews_cufon') == 'false' ) echo(' class="cufon-disabled"'); ?>>
	<div id="header-top">
		<div class="container clearfix">
			<a href="<?php bloginfo('url'); ?>">
				...
				$logo = (get_option('delicatenews_logo') <> '') ? get_option('delicatenews_logo') : get_bloginfo('template_directory').'/images/'.$colorFolder.'logo.png'; ?>
				<img src="<?php echo $logo; ?>" alt="Logo" id="logo"/>
			</a>
			
			<div id="search-form">
				<form method="get" id="searchform" action="<?php bloginfo('url'); ?>">
					<input type="text" value="<?php _e('search this site...','DelicateNews'); ?>" name="s" id="searchinput" />
				...
				<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
					<?php if (get_option('delicatenews_swap_navbar') == 'false') { ?>
						<?php if (get_option('delicatenews_home_link') == 'on') { ?>
							<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php bloginfo('url'); ?>"><?php _e('Home','DelicateNews') ?></a></li>
						<?php }; ?>
